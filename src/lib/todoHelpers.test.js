...
test('toggleTodo should not mutate todo object', () => {
    const startTodo = {id: 1, name: 'one', isComplete: false};
    const result = toggleTodo(startTodo);
...
test('updateTodo should not mutate todo array', () => {
...
test('removeTodo should remove item from an array', () => {
    const startTodos = [
        {id: 1, name: 'one', isComplete: false},
        {id: 2, name: 'two', isComplete: false},
        {id: 3, name: 'three', isComplete: false}
...
test('removeTodo should not mutate array', () => {
    const startTodos = [
        {id: 1, name: 'one', isComplete: false},
        {id: 2, name: 'two', isComplete: false},
        {id: 3, name: 'three', isComplete: false}
...
test('filterTodos should return completed todos for completed route', () => {
    const startTodos = [
        {id: 1, name: 'one', isComplete: false},
        {id: 2, name: 'two', isComplete: true},
        {id: 3, name: 'three', isComplete: false}
...
test('filterTodos should return active todos for active route', () => {
    const startTodos = [
        {id: 1, name: 'one', isComplete: false},
        {id: 2, name: 'two', isComplete: true},
        {id: 3, name: 'three', isComplete: false}
